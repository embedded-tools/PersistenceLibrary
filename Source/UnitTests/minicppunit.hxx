...
public:
   ...
   static void assertEquals( bool expected, bool result,
      const char* file="", int linia=0 );
   
   static void assertEquals( double expected, double result,
      const char* file="", int linia=0 );

   static void assertEquals( float expected, float result,
      const char* file="", int linia=0 );

   static void assertEquals( long double expected, long double result,
      const char* file="", int linia=0 );

   static void assertEquals( long expected, long result,
       const char* file, int linia=0 );

   static void assertEquals( unsigned long expected, unsigned long result,
       const char* file, int linia=0 );

   static void assertEqualsEpsilon( double expected, double result, double epsilon,
      const char* file="", int linia=0 );
